...
Mọi mệnh đề normative có code/test backing; không mệnh đề mồ côi. Bốn fact §3.6 (HTTP/2 nhiều kết nối song song, 410 -> verified=false, backoff 500/503, token-based JWT .p8) encode chính xác. Phần platform='ios' giữ ranh giới với FCM (android/web). Đối xứng đúng anh em FR-NOTIF-002. Không cần sửa. Score = 10/10. Verdict: PASS. Sẵn sàng build.

---

*Hết audit FR-NOTIF-005.*
