...
FR-CART-005 đặc tả `testCodes` ở mức triển khai được, bám đúng pseudo-code §3.5(4). 12 mệnh đề §1 normative neo vào AC §4 và test §5. Bốn ranh giới compliance sống còn (chỉ user-initiated, sleep nhịp người, revert sau mỗi thử, KHÔNG tự chốt đơn) được test khẳng định bằng grep + behavior, không chỉ quy ước - đúng yêu cầu Chrome policy 10/06/2025 (§4.2) và rủi ro ban High (§3.9c). Mã từ catalog không bruteforce. Đạt 10/10.
