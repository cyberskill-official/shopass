...
FR-CART-004 đặc tả engine luật stacking per-country ở mức triển khai được. 12 mệnh đề §1 normative neo vào AC §4 và test §5. Hai chính sách đối lập được mã hóa đúng luật thị trường: VN cho stack (1 shop + 1 platform + freeship), MY/PH 2025 bỏ stack (freeship gộp nhóm platform, loại trừ). Luật đọc CountryPolicy (FR-INFRA-005) thay vì hardcode; mặc định no-stack an toàn cho nước chưa cấu hình. Hai con số vàng §3.5(3) (110k VN, 80k MY/PH) được test khẳng định qua optimizer thật. Đạt 10/10.
