...
Audit độc lập, tái diễn từ file FR-WEB-001 hiện tại. FR đặc tả khung Next.js 14 App Router + auth JWT + shell dashboard. 12 mệnh đề §1 BCP-14 (11 MUST + 1 SHOULD), testable. Hai ranh giới bảo mật lõi - token không vào web storage (in-memory + httpOnly refresh) và web không tự xác thực mật khẩu - được test khẳng định chứ không chỉ quy ước. API client tập trung + middleware guard giữ luồng đăng nhập an toàn đầu-cuối, tiêu thụ BFF qua JWT FR-AUTH-002. Đạt 10/10.
