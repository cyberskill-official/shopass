...
Trả tức thì cho phép farm tài khoản giả rút trước khi bị phát hiện. Giải: §1 #9 + DEC-BILL-19 - phát `referral.attributed` cho FR-TRUST-004 + delay payout, không tự thưởng; AC #9 + `TestAttribute_PublishesEvent_NoDirectReward`.
