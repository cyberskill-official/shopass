...
| ID | Title | Card | Effort | Depends on | Stephen input | Status |
|----|-------|------|--------|-----------|---------------|--------|
| R20 | k6 load test gate vs NFR p95 targets | B | M | R13 | - | done |
...
| R33 | CI compliance gates (no-cleartext, consent, DPIA) | D | M | R32 | - | ready_to_review |
...
| R48 | Web performance + a11y pass, Lighthouse in CI | E | M | R38 | - | done |
