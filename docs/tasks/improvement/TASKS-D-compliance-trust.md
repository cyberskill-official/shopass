...
Why: comply-service scaffolding and the extension consent framework exist, but DSAR enforcement, breach notification, and versioned consent records are stubs per `docs/TASK-COVERAGE.md`. Legal exposure plus a blocked sales asset ("PDPL-ready by design").
