...
Why: code builds on Go 1.25 while `docs/tasks/SHIP-GUIDE.md` mandates 1.22 (`docs/AUDIT-REPORT.md` hygiene section). Drift between the contract and reality confuses every future agent. No vulnerability scanning runs today.
