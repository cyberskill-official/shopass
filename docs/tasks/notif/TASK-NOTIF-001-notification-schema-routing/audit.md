...
- DATA-MODEL line 178 ghi PK(user_id,channel) không có platform - task phát triển schema sâu hơn §3.4 dùng quy ước catalog, task là nguồn thực thi; không phải lỗi task.
