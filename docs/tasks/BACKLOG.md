...
| **TASK-INFRA-006** | Wire gateway into local compose; unpublish service ports; kill client X-User-Id trust (improvement) | MUST | implementing | TASK-INFRA-001, TASK-AUTH-002 | 6h |
